...
public class ReclamationController {
    ...
    void gotoafficher(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/com/safespot/fx/AfficherReclamation.fxml"));
    ...
    void gotoStat(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/safespot/fx/Stat.fxml"));
    ...
    void gotorep(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/safespot/fx/Reponse.fxml"));
            Parent root = loader.load();
