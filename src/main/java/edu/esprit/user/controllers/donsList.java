...
public class donsList {
    ...
    private void handleSuppButtonAction(ActionEvent actionEvent, int id) throws IOException {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/esprit/user/gui/backDonListe.fxml"));
    ...
    private void handleModifButtonAction(ActionEvent actionEvent, Don don) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/esprit/user/gui/backDonForm.fxml"));
        Parent root = loader.load();
    ...
    public void goTolIstInv(ActionEvent actionEvent) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/esprit/user/gui/backInvListe.fxml"));
        Parent root = loader.load();
        Node source = (Node) actionEvent.getSource();
        Stage stage = (Stage) source.getScene().getWindow();
        stage.setScene(new Scene(root));
